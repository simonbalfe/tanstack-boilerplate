          ...
          <Container className="bg-white rounded-[8px] mx-auto p-[20px] max-w-[600px]">
            <Section>
              ...
              <Text className="text-[16px] text-gray-600 mb-[24px]">
                Thank you for joining our platform. We&apos;re thrilled to have you as part of our
                community and can&apos;t wait to help you get the most out of your experience.
              </Text>
              <Text className="text-[16px] text-gray-600 mb-[24px]">
                To ensure you have the best possible start, please take a moment to complete your
                account setup. This will unlock all the features and personalize your experience.
              </Text>
